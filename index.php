...
<section class = "our-brands" id = "brands">
    <div class = "container">
        <div class="section-header">
            <div class="section-title">
                First Class Car Rental Service
            </div>
            <hr class="separator">
            <div class="section-tagline">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    <a class="navbar-brand" href="">
                        Pat<span style = "color:#04DBC0">el</span>&nbsp;CarRental
                    </a>
                    <p>
                        Getting dressed up and traveling with good friends makes for a shared, unforgettable experience.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class = "contact_info">
                        <li>
                            <i class="fas fa-map-marker-alt"></i>3460 Avenue Linton, Montreal, QC, H3S1T2
                        </li>
                        <li>
                            <i class="far fa-envelope"></i>contact@prentals.com
                        </li>
                        <li>
